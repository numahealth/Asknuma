    ...
    <div class="container">
        <div class="col-md-6 col-sm-8 col-xs-11 helpful_wrap"> 
            ...
            <div class="yes_no">
                ...
                <a href="#" style="cursor:pointer"  data-toggle="modal" data-target="#yes_pop_helpful" class="btn btn-success" >Yes</a>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button onclick ='yes_no_blog({{$detail[0]->id}}, "No");' type="submit" class="btn btn-success" style=" float:none"  data-dismiss="modal">Submit</button>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button onclick ='yes_no_blog({{$detail[0]->id}}, "Yes");' type="submit" class="btn btn-success" style=" float:none"  data-dismiss="modal">Submit</button>
