...
<div class="container"> 
    <div class="row disease_details">
        ...
        <?php
        echo ucfirst(str_limit($detail[0]->article_description, $limit = 1000, $end = '...</br>'))
        ?>
        <a href="{{ url('/article_details/'.	@Request::segment(2).'/'.str_replace(' ', '-',strtolower($detail[0]->article_title)))}}" class="btn btn-success">Read More</a>	
    </div>     
</div>
